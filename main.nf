...
========================================================================================
                         nf-core/hicscaff
========================================================================================
 nf-core/hicscaff Analysis Pipeline.
 #### Homepage / Documentation
 https://github.com/nf-core/hicscaff
----------------------------------------------------------------------------------------
*/
...
if (params.help) {
    ...
    def command = "nextflow run nf-core/hicscaff --input samplesheet.csv --genome GRCh37 -profile docker"
...
workflow {
    include { HICSCAFF } from './workflows/pipeline' addParams( summary_params: summary_params )
    HICSCAFF ()
}
